...
namespace Garajim.Tests.Integration
{
    public class TenantWriteRulesTests : IDisposable
    {
        ...
        public async Task BakimYakitMasrafHatirlatma_AracinSirketiniDevralir()
        {
            ...
            await new MaintenanceManager(_db.MaintenanceDal, _db.VehicleDal, _db.VehicleAccess, _db.PartDal, _db.DocumentDal, _db.DocumentService, _db.UnitOfWork).AddAsync(kullanici.Id, new MaintenanceCreateDto
            {
                VehicleId = arac.Id,
