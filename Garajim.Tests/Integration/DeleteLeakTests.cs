...
namespace Garajim.Tests.Integration
{
    public class DeleteLeakTests : IDisposable
    {
        ...
        {
            var maintenance = new MaintenanceManager(_db.MaintenanceDal, _db.VehicleDal, _db.VehicleAccess, _db.PartDal, _db.DocumentDal, _db.DocumentService, _db.UnitOfWork);
            ...
            var vehicle = new VehicleManager(_db.VehicleDal, _db.UserDal, _db.VehicleAccess, _db.CompanyDal, _db.PlanKurallari, _db.KmLogDal, TestKatalog.Yukle(), _db.DocumentDal, _db.MaintenanceDal, new SahteBelgeServisi(), _db.UnitOfWork);
