...
namespace Garajim.Tests.Integration
{
    public class OwnershipIsolationTests : IDisposable
    {
        ...
        {
            var vehicleManager = new VehicleManager(_db.VehicleDal, _db.UserDal, _db.VehicleAccess, _db.CompanyDal, _db.PlanKurallari, _db.KmLogDal, TestKatalog.Yukle(), _db.DocumentDal, _db.MaintenanceDal, new SahteBelgeServisi(), _db.UnitOfWork);
            var maintenanceManager = new MaintenanceManager(_db.MaintenanceDal, _db.VehicleDal, _db.VehicleAccess, _db.PartDal, _db.DocumentDal, _db.DocumentService, _db.UnitOfWork);
